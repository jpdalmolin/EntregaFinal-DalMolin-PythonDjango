...
def animales(request):
      animal=Animales.objects.all()
      return render(request, "AppCoder/animales.html",{'animal':animal})
...
class AnimalesList(ListView):
      ...
      model=Animales
      template_name ="animales_list.html"
...
class AnimalesCreacion(CreateView):
      ...
      model=Animales
      success_url="animales/animales/list"
      fields=['nombre','tipo','fechaDeNacimiento']


class AnimalesUpdate(LoginRequiredMixin,UpdateView):
