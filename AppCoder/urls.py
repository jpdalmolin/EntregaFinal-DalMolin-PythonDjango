...
urlpatterns = [
    ...
    path('animales/animales/list/', views.AnimalesList.as_view(), name='List'),
    path(r'^asd/(?P<pk>\+)$', views.AnimalesDetalle.as_view(),name='Detail'),
    path(r'^nuevo$', views.AnimalesCreacion.as_view(), name="New"),
    path(r'^(?P<pk>\d+)$',views.AnimalesUpdate.as_view(),name='Edit'),
    path(r'animales/(?P<pk>\d+)$',views.AnimalesDelete.as_view(),name='Delete'),
